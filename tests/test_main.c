...
static void test_hid_mapping(void)
{
	...
	hid_map_scancode(0x38, false, true, false, &mapped_code, &mapped_extended);
	assert(mapped_code == 0x5b && mapped_extended);
	hid_map_scancode(0x38, true, true, false, &mapped_code, &mapped_extended);
	assert(mapped_code == 0x5c && mapped_extended);
	hid_map_scancode(0x5b, true, true, false, &mapped_code, &mapped_extended);
	assert(mapped_code == 0x38 && !mapped_extended);
	hid_map_scancode(0x5c, true, true, false, &mapped_code, &mapped_extended);
	assert(mapped_code == 0x38 && mapped_extended);
